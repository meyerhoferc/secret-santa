...
describe 'editing a lists santa message' do
  ...
  context 'as wishlist owner' do
    it 'updates the message' do
      ...
      fill_in 'Santa message', with: 'Look here.'
      click_on 'Update message'
      expect(page).to have_content 'Message updated.'
      expect(page).to have_content 'Look here.'
      expect(page).to have_no_content 'Cheerio'
    end
  end
end
